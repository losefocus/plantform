...
export default {
  ...
  created() {
    this.getList();
    this.roleManager_btn_add = this.permissions["init_role_add"];
    this.roleManager_btn_edit = this.permissions["init_role_upd"];
    this.roleManager_btn_del = this.permissions["init_role_del"];
  },
  computed: {
