    ...
    <div class="filter-container clearfix">
      <div class="pull-right">
        <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="类型"
                  v-model="listQuery.type" size="small">
        </el-input>
        <el-button class="filter-item" type="primary" v-waves icon="search" @click="handleFilter" size="small">搜索
        </el-button>
      </div>
      <el-button v-if="sys_dict_add" class="filter-item" @click="handleCreate" type="primary" icon="edit" size="small">
        添加
      </el-button>
    </div>
...
<script>
  import {fetchList, addObj, putObj, delObj} from "@/api/init/dict";
  ...
  export default {
    ...
    created() {
      this.getList();
      this.sys_dict_add = this.permissions["init_dict_add"];
      this.sys_dict_upd = this.permissions["init_dict_upd"];
      this.sys_dict_del = this.permissions["init_dict_del"];
    },
    methods: {
